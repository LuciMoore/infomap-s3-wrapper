...
s3_bids_path="s3://EXITO/derivatives/abcd-hcp-pipeline" # BIDS directory on S3 bucket where BIDS data will be pulled from (include "s3://")
output_dir="/home/feczk001/lmoore/infomap/output/whole" # where to save the data
run_folder=`pwd`
